...
namespace MSGorilla.WebAPI.Client
{
    public static class Constant
    {
        ...
        public static string UriPostReply = "/Message/GetMessage?to={0}&message={1}&messageUser={2}&messageID={3}";
        ...
        public static string UriEventLine = "/Message/Event?eventId={0}";
